...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { having: @menu_item.having, menu_id: @menu_item.menu_id, recipe_id: @menu_item.recipe_id }
    end
  ...
  test "should update menu_item" do
    put :update, id: @menu_item, menu_item: { having: @menu_item.having, menu_id: @menu_item.menu_id, recipe_id: @menu_item.recipe_id }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
