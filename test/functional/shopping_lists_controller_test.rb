...
class ShoppingListsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post :create, shopping_list: { menu_id: @shopping_list.menu_id, shopping_list_item_id: @shopping_list.shopping_list_item_id }
    end
  ...
  test "should update shopping_list" do
    put :update, id: @shopping_list, shopping_list: { menu_id: @shopping_list.menu_id, shopping_list_item_id: @shopping_list.shopping_list_item_id }
    assert_redirected_to shopping_list_path(assigns(:shopping_list))
  end
