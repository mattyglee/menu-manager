...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { food_id: @food_item.food_id, quantity: @food_item.quantity, shopping_list_id: @food_item.shopping_list_id }
    end
  ...
  test "should update food_item" do
    put :update, id: @food_item, food_item: { food_id: @food_item.food_id, quantity: @food_item.quantity, shopping_list_id: @food_item.shopping_list_id }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
